...
# Merge stats from a thread batch into the global stats dictionary
...
if __name__ == "__main__":
    ...
    with open(filename, "r", buffering=1024*1024) as f, ThreadPoolExecutor(max_workers=workers) as executor:
        futures = []
        batch = []
        ...
        # Merge results as threads finish
